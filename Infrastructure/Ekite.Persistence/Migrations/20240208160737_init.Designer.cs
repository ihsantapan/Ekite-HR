...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ekite.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 2, 8, 19, 7, 36, 911, DateTimeKind.Local).AddTicks(2765),
                            Name = "EKİTE",
                            Status = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 2, 8, 19, 7, 36, 911, DateTimeKind.Local).AddTicks(2778),
                            Name = "Bilge ADAM",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Ekite.Domain.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 2, 8, 19, 7, 36, 911, DateTimeKind.Local).AddTicks(4023),
                            Name = "IK",
                            Status = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 2, 8, 19, 7, 36, 911, DateTimeKind.Local).AddTicks(4029),
                            Name = "Bilgi işlem",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Ekite.Domain.Entities.Job", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 2, 8, 19, 7, 36, 912, DateTimeKind.Local).AddTicks(6780),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 2, 8, 19, 7, 36, 912, DateTimeKind.Local).AddTicks(6787),
                            Name = "Proje Müdürü",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Ekite.Domain.Entities.SiteOwner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ekite.Domain.Entities.SiteOwner", b =>
                {
                    b.HasOne("Ekite.Domain.Entities.AppUser", "AppUser")
                        .WithOne("SiteOwner")
                        .HasForeignKey("Ekite.Domain.Entities.SiteOwner", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
